...
export { default as CameraColor } from './camera-color'
...
export { default as PhotoGalleryColor } from './photo-gallery-color'
...
export { default as WarningColor } from './warning-color'
