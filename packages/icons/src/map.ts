...
export const Icons = {
  ...
  "camera-color": require(base + "camera-color").default,
  ...
  "photo-gallery-color": require(base + "photo-gallery-color").default,
  "photo-gallery": require(base + "photo-gallery").default,
