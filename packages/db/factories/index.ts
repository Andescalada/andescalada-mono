...
type UserPhoneNumberFactory = {
  ...
  build: () => PromiseLike<
    Prisma.PhoneNumberCreateNestedOneWithoutUserInput["create"]
  >;
};
...
type UserprofilePhotoFactory = {
  _factoryFor: "Image";
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutUserInput["create"]
  >;
};
...
type UserFactoryDefineInput = {
  ...
  PhoneNumber?:
    | UserPhoneNumberFactory
    | Prisma.PhoneNumberCreateNestedOneWithoutUserInput;
  profilePhoto?:
    | UserprofilePhotoFactory
    | Prisma.ImageCreateNestedOneWithoutUserInput;
...
function isUserPhoneNumberFactory(
  x:
    | UserPhoneNumberFactory
    | Prisma.PhoneNumberCreateNestedOneWithoutUserInput
    | undefined,
): x is UserPhoneNumberFactory {
  return (x as any)?._factoryFor === "PhoneNumber";
}

function isUserprofilePhotoFactory(
  x:
    | UserprofilePhotoFactory
    | Prisma.ImageCreateNestedOneWithoutUserInput
    | undefined,
): x is UserprofilePhotoFactory {
...
type PhoneNumberUserFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutPhoneNumberInput["create"]
  >;
};
...
type PhoneNumberFactoryDefineInput = {
  ...
  isDeleted?: SoftDelete;
  User:
    | PhoneNumberUserFactory
    | Prisma.UserCreateNestedOneWithoutPhoneNumberInput;
};
...
function isPhoneNumberUserFactory(
  x:
    | PhoneNumberUserFactory
    | Prisma.UserCreateNestedOneWithoutPhoneNumberInput
    | undefined,
): x is PhoneNumberUserFactory {
  return (x as any)?._factoryFor === "User";
}

type PhoneNumberTraitKeys<TOptions extends PhoneNumberFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface PhoneNumberFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "PhoneNumber";
  build(
    inputData?: Partial<Prisma.PhoneNumberCreateInput>,
  ): PromiseLike<Prisma.PhoneNumberCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.PhoneNumberCreateInput>,
  ): PromiseLike<Prisma.PhoneNumberCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.PhoneNumberCreateInput>[],
  ): PromiseLike<Prisma.PhoneNumberCreateInput[]>;
  pickForConnect(inputData: PhoneNumber): Pick<PhoneNumber, "id">;
  create(
    inputData?: Partial<Prisma.PhoneNumberCreateInput>,
  ): PromiseLike<PhoneNumber>;
  createList(
    inputData: number | readonly Partial<Prisma.PhoneNumberCreateInput>[],
  ): PromiseLike<PhoneNumber[]>;
  createForConnect(
    inputData?: Partial<Prisma.PhoneNumberCreateInput>,
  ): PromiseLike<Pick<PhoneNumber, "id">>;
}

export interface PhoneNumberFactoryInterface<
  TOptions extends PhoneNumberFactoryDefineOptions = PhoneNumberFactoryDefineOptions,
> extends PhoneNumberFactoryInterfaceWithoutTraits {
  use(
    name: PhoneNumberTraitKeys<TOptions>,
    ...names: readonly PhoneNumberTraitKeys<TOptions>[]
  ): PhoneNumberFactoryInterfaceWithoutTraits;
}

function autoGeneratePhoneNumberScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): PhoneNumberScalarOrEnumFields {
  return {
    fullNumber: getScalarFieldValueGenerator().String({
...
function definePhoneNumberFactoryInternal<
  TOptions extends PhoneNumberFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): PhoneNumberFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly PhoneNumberTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        PhoneNumberFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<PhoneNumberFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.PhoneNumberCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function definePhoneNumberFactory<
  TOptions extends PhoneNumberFactoryDefineOptions,
>(options: TOptions): PhoneNumberFactoryInterface<TOptions> {
...
type HistoryuserFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutHistoryInput["create"]
  >;
};
...
type HistoryzoneFactory = {
  _factoryFor: "Zone";
  build: () => PromiseLike<
    Prisma.ZoneCreateNestedOneWithoutHistoryInput["create"]
  >;
};
...
function isHistoryuserFactory(
  x:
    | HistoryuserFactory
    | Prisma.UserCreateNestedOneWithoutHistoryInput
    | undefined,
): x is HistoryuserFactory {
  return (x as any)?._factoryFor === "User";
}

function isHistoryzoneFactory(
  x:
    | HistoryzoneFactory
    | Prisma.ZoneCreateNestedOneWithoutHistoryInput
    | undefined,
): x is HistoryzoneFactory {
  return (x as any)?._factoryFor === "Zone";
}

type HistoryTraitKeys<TOptions extends HistoryFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface HistoryFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "History";
  build(
    inputData?: Partial<Prisma.HistoryCreateInput>,
  ): PromiseLike<Prisma.HistoryCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.HistoryCreateInput>,
  ): PromiseLike<Prisma.HistoryCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.HistoryCreateInput>[],
  ): PromiseLike<Prisma.HistoryCreateInput[]>;
  ...
  createForConnect(
    inputData?: Partial<Prisma.HistoryCreateInput>,
  ): PromiseLike<Pick<History, "id">>;
}

export interface HistoryFactoryInterface<
  TOptions extends HistoryFactoryDefineOptions = HistoryFactoryDefineOptions,
> extends HistoryFactoryInterfaceWithoutTraits {
  use(
    name: HistoryTraitKeys<TOptions>,
    ...names: readonly HistoryTraitKeys<TOptions>[]
  ): HistoryFactoryInterfaceWithoutTraits;
}

function autoGenerateHistoryScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineHistoryFactoryInternal<
  TOptions extends HistoryFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): HistoryFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly HistoryTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        HistoryFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<HistoryFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function defineHistoryFactory<
  TOptions extends HistoryFactoryDefineOptions,
>(options: TOptions): HistoryFactoryInterface<TOptions> {
...
type RoleByZoneUserFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutRoleByZoneInput["create"]
  >;
};
...
type RoleByZoneZoneFactory = {
  _factoryFor: "Zone";
  build: () => PromiseLike<
    Prisma.ZoneCreateNestedOneWithoutRoleByZoneInput["create"]
  >;
};
...
type RoleByZoneRoleFactory = {
  _factoryFor: "Role";
  build: () => PromiseLike<
    Prisma.RoleCreateNestedOneWithoutRoleByZoneInput["create"]
  >;
};
...
type RoleByZoneAssignedByFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAssignedRolesInput["create"]
  >;
};
...
type RoleByZoneFactoryDefineInput = {
  ...
  version?: number;
  User:
    | RoleByZoneUserFactory
    | Prisma.UserCreateNestedOneWithoutRoleByZoneInput;
  Zone:
    | RoleByZoneZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutRoleByZoneInput;
  Role:
    | RoleByZoneRoleFactory
    | Prisma.RoleCreateNestedOneWithoutRoleByZoneInput;
  AssignedBy:
    | RoleByZoneAssignedByFactory
    | Prisma.UserCreateNestedOneWithoutAssignedRolesInput;
};
...
function isRoleByZoneUserFactory(
  x:
    | RoleByZoneUserFactory
    | Prisma.UserCreateNestedOneWithoutRoleByZoneInput
    | undefined,
): x is RoleByZoneUserFactory {
  return (x as any)?._factoryFor === "User";
}

function isRoleByZoneZoneFactory(
  x:
    | RoleByZoneZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutRoleByZoneInput
    | undefined,
): x is RoleByZoneZoneFactory {
  return (x as any)?._factoryFor === "Zone";
}

function isRoleByZoneRoleFactory(
  x:
    | RoleByZoneRoleFactory
    | Prisma.RoleCreateNestedOneWithoutRoleByZoneInput
    | undefined,
): x is RoleByZoneRoleFactory {
  return (x as any)?._factoryFor === "Role";
}

function isRoleByZoneAssignedByFactory(
  x:
    | RoleByZoneAssignedByFactory
    | Prisma.UserCreateNestedOneWithoutAssignedRolesInput
    | undefined,
): x is RoleByZoneAssignedByFactory {
  return (x as any)?._factoryFor === "User";
}

type RoleByZoneTraitKeys<TOptions extends RoleByZoneFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface RoleByZoneFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "RoleByZone";
  build(
    inputData?: Partial<Prisma.RoleByZoneCreateInput>,
  ): PromiseLike<Prisma.RoleByZoneCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.RoleByZoneCreateInput>,
  ): PromiseLike<Prisma.RoleByZoneCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.RoleByZoneCreateInput>[],
  ): PromiseLike<Prisma.RoleByZoneCreateInput[]>;
  pickForConnect(inputData: RoleByZone): Pick<RoleByZone, "id">;
  create(
    inputData?: Partial<Prisma.RoleByZoneCreateInput>,
  ): PromiseLike<RoleByZone>;
  createList(
    inputData: number | readonly Partial<Prisma.RoleByZoneCreateInput>[],
  ): PromiseLike<RoleByZone[]>;
  createForConnect(
    inputData?: Partial<Prisma.RoleByZoneCreateInput>,
  ): PromiseLike<Pick<RoleByZone, "id">>;
}

export interface RoleByZoneFactoryInterface<
  TOptions extends RoleByZoneFactoryDefineOptions = RoleByZoneFactoryDefineOptions,
> extends RoleByZoneFactoryInterfaceWithoutTraits {
  use(
    name: RoleByZoneTraitKeys<TOptions>,
    ...names: readonly RoleByZoneTraitKeys<TOptions>[]
  ): RoleByZoneFactoryInterfaceWithoutTraits;
}

function autoGenerateRoleByZoneScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineRoleByZoneFactoryInternal<
  TOptions extends RoleByZoneFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): RoleByZoneFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly RoleByZoneTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        RoleByZoneFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<RoleByZoneFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.RoleByZoneCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineRoleByZoneFactory<
  TOptions extends RoleByZoneFactoryDefineOptions,
>(options: TOptions): RoleByZoneFactoryInterface<TOptions> {
...
type UserZoneAgreementRecordZoneFactory = {
  _factoryFor: "Zone";
  build: () => PromiseLike<
    Prisma.ZoneCreateNestedOneWithoutUserZoneAgreementHistoryInput["create"]
  >;
};
...
type UserZoneAgreementRecordUserFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutUserZoneAgreementHistoryInput["create"]
  >;
};
...
type UserZoneAgreementRecordFactoryDefineInput = {
  ...
  agreementsRecord?: string;
  Zone:
    | UserZoneAgreementRecordZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutUserZoneAgreementHistoryInput;
  User:
    | UserZoneAgreementRecordUserFactory
    | Prisma.UserCreateNestedOneWithoutUserZoneAgreementHistoryInput;
};

type UserZoneAgreementRecordFactoryDefineOptions = {
  defaultData: Resolver<
    UserZoneAgreementRecordFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<UserZoneAgreementRecordFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
function isUserZoneAgreementRecordZoneFactory(
  x:
    | UserZoneAgreementRecordZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutUserZoneAgreementHistoryInput
    | undefined,
): x is UserZoneAgreementRecordZoneFactory {
  return (x as any)?._factoryFor === "Zone";
}

function isUserZoneAgreementRecordUserFactory(
  x:
    | UserZoneAgreementRecordUserFactory
    | Prisma.UserCreateNestedOneWithoutUserZoneAgreementHistoryInput
    | undefined,
): x is UserZoneAgreementRecordUserFactory {
  return (x as any)?._factoryFor === "User";
}

type UserZoneAgreementRecordTraitKeys<
  TOptions extends UserZoneAgreementRecordFactoryDefineOptions,
> = keyof TOptions["traits"];

export interface UserZoneAgreementRecordFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "UserZoneAgreementRecord";
  build(
    inputData?: Partial<Prisma.UserZoneAgreementRecordCreateInput>,
  ): PromiseLike<Prisma.UserZoneAgreementRecordCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.UserZoneAgreementRecordCreateInput>,
  ): PromiseLike<Prisma.UserZoneAgreementRecordCreateInput>;
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.UserZoneAgreementRecordCreateInput>[],
  ): PromiseLike<Prisma.UserZoneAgreementRecordCreateInput[]>;
  pickForConnect(
    inputData: UserZoneAgreementRecord,
  ): Pick<UserZoneAgreementRecord, "id">;
  create(
    inputData?: Partial<Prisma.UserZoneAgreementRecordCreateInput>,
  ): PromiseLike<UserZoneAgreementRecord>;
  createList(
    inputData:
      | number
      | readonly Partial<Prisma.UserZoneAgreementRecordCreateInput>[],
  ...
  createForConnect(
    inputData?: Partial<Prisma.UserZoneAgreementRecordCreateInput>,
  ): PromiseLike<Pick<UserZoneAgreementRecord, "id">>;
}

export interface UserZoneAgreementRecordFactoryInterface<
  TOptions extends UserZoneAgreementRecordFactoryDefineOptions = UserZoneAgreementRecordFactoryDefineOptions,
> extends UserZoneAgreementRecordFactoryInterfaceWithoutTraits {
  use(
    name: UserZoneAgreementRecordTraitKeys<TOptions>,
    ...names: readonly UserZoneAgreementRecordTraitKeys<TOptions>[]
  ): UserZoneAgreementRecordFactoryInterfaceWithoutTraits;
}

function autoGenerateUserZoneAgreementRecordScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): UserZoneAgreementRecordScalarOrEnumFields {
  return {
    hasAgreed: getScalarFieldValueGenerator().Boolean({
      modelName: "UserZoneAgreementRecord",
      fieldName: "hasAgreed",
      isId: false,
      isUnique: false,
      seq,
    }),
    agreementsRecord: getScalarFieldValueGenerator().String({
      modelName: "UserZoneAgreementRecord",
      fieldName: "agreementsRecord",
      isId: false,
      isUnique: false,
      seq,
    }),
...
function defineUserZoneAgreementRecordFactoryInternal<
  TOptions extends UserZoneAgreementRecordFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): UserZoneAgreementRecordFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly UserZoneAgreementRecordTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const requiredScalarData =
        autoGenerateUserZoneAgreementRecordScalarsOrEnums({ seq });
      const resolveValue = normalizeResolver<
        UserZoneAgreementRecordFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      ...
      const data: Prisma.UserZoneAgreementRecordCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
    ...
    const create = async (
      ...
      const data = await build(inputData).then(screen);
      return await getClient<PrismaClient>().userZoneAgreementRecord.create({
        data,
      });
    };
    const createList = (
 ...
 */
export function defineUserZoneAgreementRecordFactory<
  TOptions extends UserZoneAgreementRecordFactoryDefineOptions,
>(options: TOptions): UserZoneAgreementRecordFactoryInterface<TOptions> {
...
type RoleTraitKeys<TOptions extends RoleFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface RoleFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Role";
  build(
    inputData?: Partial<Prisma.RoleCreateInput>,
  ): PromiseLike<Prisma.RoleCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.RoleCreateInput>,
  ): PromiseLike<Prisma.RoleCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.RoleCreateInput>[],
  ): PromiseLike<Prisma.RoleCreateInput[]>;
  ...
  createForConnect(
    inputData?: Partial<Prisma.RoleCreateInput>,
  ): PromiseLike<Pick<Role, "id">>;
}

export interface RoleFactoryInterface<
  TOptions extends RoleFactoryDefineOptions = RoleFactoryDefineOptions,
> extends RoleFactoryInterfaceWithoutTraits {
  use(
    name: RoleTraitKeys<TOptions>,
    ...names: readonly RoleTraitKeys<TOptions>[]
  ): RoleFactoryInterfaceWithoutTraits;
}

function autoGenerateRoleScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineRoleFactoryInternal<TOptions extends RoleFactoryDefineOptions>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): RoleFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly RoleTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (inputData: Partial<Prisma.RoleCreateInput> = {}) => {
      ...
      const resolveValue = normalizeResolver<
        RoleFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<RoleFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function defineRoleFactory<TOptions extends RoleFactoryDefineOptions>(
  options?: TOptions,
): RoleFactoryInterface<TOptions> {
...
type PermissionsTraitKeys<TOptions extends PermissionsFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface PermissionsFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Permissions";
  build(
    inputData?: Partial<Prisma.PermissionsCreateInput>,
  ): PromiseLike<Prisma.PermissionsCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.PermissionsCreateInput>,
  ): PromiseLike<Prisma.PermissionsCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.PermissionsCreateInput>[],
  ): PromiseLike<Prisma.PermissionsCreateInput[]>;
  pickForConnect(inputData: Permissions): Pick<Permissions, "id">;
  create(
    inputData?: Partial<Prisma.PermissionsCreateInput>,
  ): PromiseLike<Permissions>;
  createList(
    inputData: number | readonly Partial<Prisma.PermissionsCreateInput>[],
  ): PromiseLike<Permissions[]>;
  createForConnect(
    inputData?: Partial<Prisma.PermissionsCreateInput>,
  ): PromiseLike<Pick<Permissions, "id">>;
}

export interface PermissionsFactoryInterface<
  TOptions extends PermissionsFactoryDefineOptions = PermissionsFactoryDefineOptions,
> extends PermissionsFactoryInterfaceWithoutTraits {
  use(
    name: PermissionsTraitKeys<TOptions>,
    ...names: readonly PermissionsTraitKeys<TOptions>[]
  ): PermissionsFactoryInterfaceWithoutTraits;
}

function autoGeneratePermissionsScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function definePermissionsFactoryInternal<
  TOptions extends PermissionsFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): PermissionsFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly PermissionsTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        PermissionsFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<PermissionsFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function definePermissionsFactory<
  TOptions extends PermissionsFactoryDefineOptions,
>(options?: TOptions): PermissionsFactoryInterface<TOptions> {
...
type ZoneAccessRequestZoneFactory = {
  _factoryFor: "Zone";
  build: () => PromiseLike<
    Prisma.ZoneCreateNestedOneWithoutZoneAccessRequestInput["create"]
  >;
};
...
type ZoneAccessRequestUserFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutZoneAccessRequestHistoryInput["create"]
  >;
};
...
type ZoneAccessRequestmodifiedByFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutZoneAccessRequestReviewedInput["create"]
  >;
};
...
type ZoneAccessRequestmessageFactory = {
  ...
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutZoneAccessRequestInput["create"]
  >;
};
...
type ZoneAccessRequestFactoryDefineInput = {
  ...
  status?: RequestStatus;
  Zone:
    | ZoneAccessRequestZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutZoneAccessRequestInput;
  User:
    | ZoneAccessRequestUserFactory
    | Prisma.UserCreateNestedOneWithoutZoneAccessRequestHistoryInput;
  modifiedBy:
    | ZoneAccessRequestmodifiedByFactory
    | Prisma.UserCreateNestedOneWithoutZoneAccessRequestReviewedInput;
  message?:
    | ZoneAccessRequestmessageFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneAccessRequestInput;
};
...
type ZoneAccessRequestFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<ZoneAccessRequestFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
function isZoneAccessRequestZoneFactory(
  x:
    | ZoneAccessRequestZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutZoneAccessRequestInput
    | undefined,
): x is ZoneAccessRequestZoneFactory {
  return (x as any)?._factoryFor === "Zone";
}

function isZoneAccessRequestUserFactory(
  x:
    | ZoneAccessRequestUserFactory
    | Prisma.UserCreateNestedOneWithoutZoneAccessRequestHistoryInput
    | undefined,
): x is ZoneAccessRequestUserFactory {
  return (x as any)?._factoryFor === "User";
}

function isZoneAccessRequestmodifiedByFactory(
  x:
    | ZoneAccessRequestmodifiedByFactory
    | Prisma.UserCreateNestedOneWithoutZoneAccessRequestReviewedInput
    | undefined,
): x is ZoneAccessRequestmodifiedByFactory {
  return (x as any)?._factoryFor === "User";
}

function isZoneAccessRequestmessageFactory(
  x:
    | ZoneAccessRequestmessageFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneAccessRequestInput
    | undefined,
): x is ZoneAccessRequestmessageFactory {
  return (x as any)?._factoryFor === "TextContent";
}

type ZoneAccessRequestTraitKeys<
  TOptions extends ZoneAccessRequestFactoryDefineOptions,
> = keyof TOptions["traits"];

export interface ZoneAccessRequestFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "ZoneAccessRequest";
  build(
    inputData?: Partial<Prisma.ZoneAccessRequestCreateInput>,
  ): PromiseLike<Prisma.ZoneAccessRequestCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.ZoneAccessRequestCreateInput>,
  ): PromiseLike<Prisma.ZoneAccessRequestCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.ZoneAccessRequestCreateInput>[],
  ): PromiseLike<Prisma.ZoneAccessRequestCreateInput[]>;
  pickForConnect(inputData: ZoneAccessRequest): Pick<ZoneAccessRequest, "id">;
  create(
    inputData?: Partial<Prisma.ZoneAccessRequestCreateInput>,
  ): PromiseLike<ZoneAccessRequest>;
  createList(
    inputData: number | readonly Partial<Prisma.ZoneAccessRequestCreateInput>[],
  ): PromiseLike<ZoneAccessRequest[]>;
  createForConnect(
    inputData?: Partial<Prisma.ZoneAccessRequestCreateInput>,
  ): PromiseLike<Pick<ZoneAccessRequest, "id">>;
}

export interface ZoneAccessRequestFactoryInterface<
  TOptions extends ZoneAccessRequestFactoryDefineOptions = ZoneAccessRequestFactoryDefineOptions,
> extends ZoneAccessRequestFactoryInterfaceWithoutTraits {
  use(
    name: ZoneAccessRequestTraitKeys<TOptions>,
    ...names: readonly ZoneAccessRequestTraitKeys<TOptions>[]
  ): ZoneAccessRequestFactoryInterfaceWithoutTraits;
}

function autoGenerateZoneAccessRequestScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineZoneAccessRequestFactoryInternal<
  TOptions extends ZoneAccessRequestFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): ZoneAccessRequestFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly ZoneAccessRequestTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const seq = getSeq();
      const requiredScalarData = autoGenerateZoneAccessRequestScalarsOrEnums({
        seq,
      });
      const resolveValue = normalizeResolver<
        ZoneAccessRequestFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
      ...
      const data: Prisma.ZoneAccessRequestCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
    ...
    const buildList = (
      inputData:
        | number
        | readonly Partial<Prisma.ZoneAccessRequestCreateInput>[],
    ) => Promise.all(normalizeList(inputData).map((data) => build(data)));
 ...
 */
export function defineZoneAccessRequestFactory<
  TOptions extends ZoneAccessRequestFactoryDefineOptions,
>(options: TOptions): ZoneAccessRequestFactoryInterface<TOptions> {
...
type ZonedescriptionFactory = {
  _factoryFor: "TextContent";
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutZoneInput["create"]
  >;
};
...
type ZoneLocationFactory = {
  ...
  build: () => PromiseLike<
    Prisma.LocationCreateNestedOneWithoutZoneInput["create"]
  >;
};
...
type ZoneAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorZoneInput["create"]
  >;
};
...
type ZoneFactoryDefineInput = {
  ...
  description?:
    | ZonedescriptionFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneInput;
  ...
  Location?:
    | ZoneLocationFactory
    | Prisma.LocationCreateNestedOneWithoutZoneInput;
...
function isZonedescriptionFactory(
  x:
    | ZonedescriptionFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneInput
    | undefined,
): x is ZonedescriptionFactory {
  return (x as any)?._factoryFor === "TextContent";
}

function isZoneLocationFactory(
  x:
    | ZoneLocationFactory
    | Prisma.LocationCreateNestedOneWithoutZoneInput
    | undefined,
): x is ZoneLocationFactory {
  return (x as any)?._factoryFor === "Location";
}

function isZoneAuthorFactory(
  x:
    | ZoneAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorZoneInput
    | undefined,
): x is ZoneAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

type ZoneTraitKeys<TOptions extends ZoneFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface ZoneFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Zone";
  build(
    inputData?: Partial<Prisma.ZoneCreateInput>,
  ): PromiseLike<Prisma.ZoneCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.ZoneCreateInput>,
  ): PromiseLike<Prisma.ZoneCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.ZoneCreateInput>[],
  ): PromiseLike<Prisma.ZoneCreateInput[]>;
  ...
  createForConnect(
    inputData?: Partial<Prisma.ZoneCreateInput>,
  ): PromiseLike<Pick<Zone, "id">>;
}

export interface ZoneFactoryInterface<
  TOptions extends ZoneFactoryDefineOptions = ZoneFactoryDefineOptions,
> extends ZoneFactoryInterfaceWithoutTraits {
  use(
    name: ZoneTraitKeys<TOptions>,
    ...names: readonly ZoneTraitKeys<TOptions>[]
  ): ZoneFactoryInterfaceWithoutTraits;
}

function autoGenerateZoneScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineZoneFactoryInternal<TOptions extends ZoneFactoryDefineOptions>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): ZoneFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly ZoneTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (inputData: Partial<Prisma.ZoneCreateInput> = {}) => {
      ...
      const resolveValue = normalizeResolver<
        ZoneFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<ZoneFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function defineZoneFactory<TOptions extends ZoneFactoryDefineOptions>(
  options: TOptions,
): ZoneFactoryInterface<TOptions> {
...
type ZoneStatusmessageFactory = {
  _factoryFor: "TextContent";
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutZoneStatusInput["create"]
  >;
};
...
type ZoneStatusmodifiedByFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutZoneStatusModificationsInput["create"]
  >;
};
...
type ZoneStatusFactoryDefineInput = {
  ...
  createdAt?: Date;
  message?:
    | ZoneStatusmessageFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneStatusInput;
  Zone?: Prisma.ZoneCreateNestedManyWithoutStatusHistoryInput;
  modifiedBy:
    | ZoneStatusmodifiedByFactory
    | Prisma.UserCreateNestedOneWithoutZoneStatusModificationsInput;
};
...
function isZoneStatusmessageFactory(
  x:
    | ZoneStatusmessageFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneStatusInput
    | undefined,
): x is ZoneStatusmessageFactory {
  return (x as any)?._factoryFor === "TextContent";
}

function isZoneStatusmodifiedByFactory(
  x:
    | ZoneStatusmodifiedByFactory
    | Prisma.UserCreateNestedOneWithoutZoneStatusModificationsInput
    | undefined,
): x is ZoneStatusmodifiedByFactory {
  return (x as any)?._factoryFor === "User";
}

type ZoneStatusTraitKeys<TOptions extends ZoneStatusFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface ZoneStatusFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "ZoneStatus";
  build(
    inputData?: Partial<Prisma.ZoneStatusCreateInput>,
  ): PromiseLike<Prisma.ZoneStatusCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.ZoneStatusCreateInput>,
  ): PromiseLike<Prisma.ZoneStatusCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.ZoneStatusCreateInput>[],
  ): PromiseLike<Prisma.ZoneStatusCreateInput[]>;
  pickForConnect(inputData: ZoneStatus): Pick<ZoneStatus, "id">;
  create(
    inputData?: Partial<Prisma.ZoneStatusCreateInput>,
  ): PromiseLike<ZoneStatus>;
  createList(
    inputData: number | readonly Partial<Prisma.ZoneStatusCreateInput>[],
  ): PromiseLike<ZoneStatus[]>;
  createForConnect(
    inputData?: Partial<Prisma.ZoneStatusCreateInput>,
  ): PromiseLike<Pick<ZoneStatus, "id">>;
}

export interface ZoneStatusFactoryInterface<
  TOptions extends ZoneStatusFactoryDefineOptions = ZoneStatusFactoryDefineOptions,
> extends ZoneStatusFactoryInterfaceWithoutTraits {
  use(
    name: ZoneStatusTraitKeys<TOptions>,
    ...names: readonly ZoneStatusTraitKeys<TOptions>[]
  ): ZoneStatusFactoryInterfaceWithoutTraits;
}

function autoGenerateZoneStatusScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineZoneStatusFactoryInternal<
  TOptions extends ZoneStatusFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): ZoneStatusFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly ZoneStatusTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        ZoneStatusFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<ZoneStatusFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.ZoneStatusCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineZoneStatusFactory<
  TOptions extends ZoneStatusFactoryDefineOptions,
>(options: TOptions): ZoneStatusFactoryInterface<TOptions> {
...
type ZoneAgreementcommentFactory = {
  _factoryFor: "TextContent";
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutZoneAgreementCommentInput["create"]
  >;
};
...
type ZoneAgreementZoneFactory = {
  _factoryFor: "Zone";
  build: () => PromiseLike<
    Prisma.ZoneCreateNestedOneWithoutAgreementsInput["create"]
  >;
};
...
type ZoneAgreementAgreementFactory = {
  ...
  build: () => PromiseLike<
    Prisma.AgreementCreateNestedOneWithoutZoneAgreementInput["create"]
  >;
};
...
type ZoneAgreementAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorZoneListAgreementsInput["create"]
  >;
};
...
type ZoneAgreementFactoryDefineInput = {
  ...
  version?: number;
  comment?:
    | ZoneAgreementcommentFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneAgreementCommentInput;
  Zone:
    | ZoneAgreementZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutAgreementsInput;
  Agreement:
    | ZoneAgreementAgreementFactory
    | Prisma.AgreementCreateNestedOneWithoutZoneAgreementInput;
  Author:
    | ZoneAgreementAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorZoneListAgreementsInput;
...
type ZoneAgreementFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<ZoneAgreementFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
function isZoneAgreementcommentFactory(
  x:
    | ZoneAgreementcommentFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneAgreementCommentInput
    | undefined,
): x is ZoneAgreementcommentFactory {
  return (x as any)?._factoryFor === "TextContent";
}

function isZoneAgreementZoneFactory(
  x:
    | ZoneAgreementZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutAgreementsInput
    | undefined,
): x is ZoneAgreementZoneFactory {
  return (x as any)?._factoryFor === "Zone";
}

function isZoneAgreementAgreementFactory(
  x:
    | ZoneAgreementAgreementFactory
    | Prisma.AgreementCreateNestedOneWithoutZoneAgreementInput
    | undefined,
): x is ZoneAgreementAgreementFactory {
  return (x as any)?._factoryFor === "Agreement";
}

function isZoneAgreementAuthorFactory(
  x:
    | ZoneAgreementAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorZoneListAgreementsInput
    | undefined,
): x is ZoneAgreementAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

type ZoneAgreementTraitKeys<
  TOptions extends ZoneAgreementFactoryDefineOptions,
> = keyof TOptions["traits"];

export interface ZoneAgreementFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "ZoneAgreement";
  build(
    inputData?: Partial<Prisma.ZoneAgreementCreateInput>,
  ): PromiseLike<Prisma.ZoneAgreementCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.ZoneAgreementCreateInput>,
  ): PromiseLike<Prisma.ZoneAgreementCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.ZoneAgreementCreateInput>[],
  ): PromiseLike<Prisma.ZoneAgreementCreateInput[]>;
  pickForConnect(inputData: ZoneAgreement): Pick<ZoneAgreement, "id">;
  create(
    inputData?: Partial<Prisma.ZoneAgreementCreateInput>,
  ): PromiseLike<ZoneAgreement>;
  createList(
    inputData: number | readonly Partial<Prisma.ZoneAgreementCreateInput>[],
  ): PromiseLike<ZoneAgreement[]>;
  createForConnect(
    inputData?: Partial<Prisma.ZoneAgreementCreateInput>,
  ): PromiseLike<Pick<ZoneAgreement, "id">>;
}

export interface ZoneAgreementFactoryInterface<
  TOptions extends ZoneAgreementFactoryDefineOptions = ZoneAgreementFactoryDefineOptions,
> extends ZoneAgreementFactoryInterfaceWithoutTraits {
  use(
    name: ZoneAgreementTraitKeys<TOptions>,
    ...names: readonly ZoneAgreementTraitKeys<TOptions>[]
  ): ZoneAgreementFactoryInterfaceWithoutTraits;
}

function autoGenerateZoneAgreementScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineZoneAgreementFactoryInternal<
  TOptions extends ZoneAgreementFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): ZoneAgreementFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly ZoneAgreementTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const seq = getSeq();
      const requiredScalarData = autoGenerateZoneAgreementScalarsOrEnums({
        seq,
      });
      const resolveValue = normalizeResolver<
        ZoneAgreementFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
      ...
      const data: Prisma.ZoneAgreementCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineZoneAgreementFactory<
  TOptions extends ZoneAgreementFactoryDefineOptions,
>(options: TOptions): ZoneAgreementFactoryInterface<TOptions> {
...
type AgreementtitleFactory = {
  _factoryFor: "TextContent";
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutAgreementNameInput["create"]
  >;
};
...
type AgreementdescriptionFactory = {
  _factoryFor: "TextContent";
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutAgreementDescriptionInput["create"]
  >;
};
...
type AgreementAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorAgreementsInput["create"]
  >;
};
...
type AgreementFactoryDefineInput = {
  ...
  icon?: string | null;
  title:
    | AgreementtitleFactory
    | Prisma.TextContentCreateNestedOneWithoutAgreementNameInput;
  description:
    | AgreementdescriptionFactory
    | Prisma.TextContentCreateNestedOneWithoutAgreementDescriptionInput;
  Author:
    | AgreementAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorAgreementsInput;
...
function isAgreementtitleFactory(
  x:
    | AgreementtitleFactory
    | Prisma.TextContentCreateNestedOneWithoutAgreementNameInput
    | undefined,
): x is AgreementtitleFactory {
  return (x as any)?._factoryFor === "TextContent";
}

function isAgreementdescriptionFactory(
  x:
    | AgreementdescriptionFactory
    | Prisma.TextContentCreateNestedOneWithoutAgreementDescriptionInput
    | undefined,
): x is AgreementdescriptionFactory {
  return (x as any)?._factoryFor === "TextContent";
}

function isAgreementAuthorFactory(
  x:
    | AgreementAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorAgreementsInput
    | undefined,
): x is AgreementAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

type AgreementTraitKeys<TOptions extends AgreementFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface AgreementFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Agreement";
  build(
    inputData?: Partial<Prisma.AgreementCreateInput>,
  ): PromiseLike<Prisma.AgreementCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.AgreementCreateInput>,
  ): PromiseLike<Prisma.AgreementCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.AgreementCreateInput>[],
  ): PromiseLike<Prisma.AgreementCreateInput[]>;
  pickForConnect(inputData: Agreement): Pick<Agreement, "id">;
  create(
    inputData?: Partial<Prisma.AgreementCreateInput>,
  ): PromiseLike<Agreement>;
  createList(
    inputData: number | readonly Partial<Prisma.AgreementCreateInput>[],
  ): PromiseLike<Agreement[]>;
  createForConnect(
    inputData?: Partial<Prisma.AgreementCreateInput>,
  ): PromiseLike<Pick<Agreement, "id">>;
}

export interface AgreementFactoryInterface<
  TOptions extends AgreementFactoryDefineOptions = AgreementFactoryDefineOptions,
> extends AgreementFactoryInterfaceWithoutTraits {
  use(
    name: AgreementTraitKeys<TOptions>,
    ...names: readonly AgreementTraitKeys<TOptions>[]
  ): AgreementFactoryInterfaceWithoutTraits;
}

function autoGenerateAgreementScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineAgreementFactoryInternal<
  TOptions extends AgreementFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): AgreementFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly AgreementTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        AgreementFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<AgreementFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.AgreementCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineAgreementFactory<
  TOptions extends AgreementFactoryDefineOptions,
>(options: TOptions): AgreementFactoryInterface<TOptions> {
...
type ZoneDirectionsnameFactory = {
  _factoryFor: "TextContent";
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutZoneDirectionsNameInput["create"]
  >;
};
...
type ZoneDirectionsZoneFactory = {
  _factoryFor: "Zone";
  build: () => PromiseLike<
    Prisma.ZoneCreateNestedOneWithoutZoneDirectionsInput["create"]
  >;
};
...
type ZoneDirectionsdescriptionFactory = {
  _factoryFor: "TextContent";
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutZoneDirectionsInput["create"]
  >;
};
...
type ZoneDirectionsAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorZoneDirectionsInput["create"]
  >;
};
...
type ZoneDirectionsFactoryDefineInput = {
  ...
  isDeleted?: SoftDelete;
  name?:
    | ZoneDirectionsnameFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneDirectionsNameInput;
  Zone:
    | ZoneDirectionsZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutZoneDirectionsInput;
  description?:
    | ZoneDirectionsdescriptionFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneDirectionsInput;
  Author:
    | ZoneDirectionsAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorZoneDirectionsInput;
...
type ZoneDirectionsFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<ZoneDirectionsFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
function isZoneDirectionsnameFactory(
  x:
    | ZoneDirectionsnameFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneDirectionsNameInput
    | undefined,
): x is ZoneDirectionsnameFactory {
  return (x as any)?._factoryFor === "TextContent";
}

function isZoneDirectionsZoneFactory(
  x:
    | ZoneDirectionsZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutZoneDirectionsInput
    | undefined,
): x is ZoneDirectionsZoneFactory {
  return (x as any)?._factoryFor === "Zone";
}

function isZoneDirectionsdescriptionFactory(
  x:
    | ZoneDirectionsdescriptionFactory
    | Prisma.TextContentCreateNestedOneWithoutZoneDirectionsInput
    | undefined,
): x is ZoneDirectionsdescriptionFactory {
  return (x as any)?._factoryFor === "TextContent";
}

function isZoneDirectionsAuthorFactory(
  x:
    | ZoneDirectionsAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorZoneDirectionsInput
    | undefined,
): x is ZoneDirectionsAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

type ZoneDirectionsTraitKeys<
  TOptions extends ZoneDirectionsFactoryDefineOptions,
> = keyof TOptions["traits"];

export interface ZoneDirectionsFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "ZoneDirections";
  build(
    inputData?: Partial<Prisma.ZoneDirectionsCreateInput>,
  ): PromiseLike<Prisma.ZoneDirectionsCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.ZoneDirectionsCreateInput>,
  ): PromiseLike<Prisma.ZoneDirectionsCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.ZoneDirectionsCreateInput>[],
  ): PromiseLike<Prisma.ZoneDirectionsCreateInput[]>;
  pickForConnect(inputData: ZoneDirections): Pick<ZoneDirections, "id">;
  create(
    inputData?: Partial<Prisma.ZoneDirectionsCreateInput>,
  ): PromiseLike<ZoneDirections>;
  createList(
    inputData: number | readonly Partial<Prisma.ZoneDirectionsCreateInput>[],
  ): PromiseLike<ZoneDirections[]>;
  createForConnect(
    inputData?: Partial<Prisma.ZoneDirectionsCreateInput>,
  ): PromiseLike<Pick<ZoneDirections, "id">>;
}

export interface ZoneDirectionsFactoryInterface<
  TOptions extends ZoneDirectionsFactoryDefineOptions = ZoneDirectionsFactoryDefineOptions,
> extends ZoneDirectionsFactoryInterfaceWithoutTraits {
  use(
    name: ZoneDirectionsTraitKeys<TOptions>,
    ...names: readonly ZoneDirectionsTraitKeys<TOptions>[]
  ): ZoneDirectionsFactoryInterfaceWithoutTraits;
}

function autoGenerateZoneDirectionsScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineZoneDirectionsFactoryInternal<
  TOptions extends ZoneDirectionsFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): ZoneDirectionsFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly ZoneDirectionsTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const seq = getSeq();
      const requiredScalarData = autoGenerateZoneDirectionsScalarsOrEnums({
        seq,
      });
      const resolveValue = normalizeResolver<
        ZoneDirectionsFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
      ...
      const data: Prisma.ZoneDirectionsCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineZoneDirectionsFactory<
  TOptions extends ZoneDirectionsFactoryDefineOptions,
>(options: TOptions): ZoneDirectionsFactoryInterface<TOptions> {
...
type SectorZoneFactory = {
  _factoryFor: "Zone";
  build: () => PromiseLike<
    Prisma.ZoneCreateNestedOneWithoutSectorsInput["create"]
  >;
};
...
type SectorAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorSectorInput["create"]
  >;
};
...
type SectorLocationFactory = {
  _factoryFor: "Location";
  build: () => PromiseLike<
    Prisma.LocationCreateNestedOneWithoutSectorInput["create"]
  >;
};
...
type SectorFactoryDefineInput = {
  ...
  Author:
    | SectorAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorSectorInput;
  coAuthors?: Prisma.UserCreateNestedManyWithoutCoAuthorSectorInput;
  Location?:
    | SectorLocationFactory
    | Prisma.LocationCreateNestedOneWithoutSectorInput;
};
...
function isSectorZoneFactory(
  x:
    | SectorZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutSectorsInput
    | undefined,
): x is SectorZoneFactory {
  return (x as any)?._factoryFor === "Zone";
}

function isSectorAuthorFactory(
  x:
    | SectorAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorSectorInput
    | undefined,
): x is SectorAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

function isSectorLocationFactory(
  x:
    | SectorLocationFactory
    | Prisma.LocationCreateNestedOneWithoutSectorInput
    | undefined,
): x is SectorLocationFactory {
  return (x as any)?._factoryFor === "Location";
}

type SectorTraitKeys<TOptions extends SectorFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface SectorFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Sector";
  build(
    inputData?: Partial<Prisma.SectorCreateInput>,
  ): PromiseLike<Prisma.SectorCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.SectorCreateInput>,
  ): PromiseLike<Prisma.SectorCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.SectorCreateInput>[],
  ): PromiseLike<Prisma.SectorCreateInput[]>;
  ...
  createForConnect(
    inputData?: Partial<Prisma.SectorCreateInput>,
  ): PromiseLike<Pick<Sector, "id">>;
}

export interface SectorFactoryInterface<
  TOptions extends SectorFactoryDefineOptions = SectorFactoryDefineOptions,
> extends SectorFactoryInterfaceWithoutTraits {
  use(
    name: SectorTraitKeys<TOptions>,
    ...names: readonly SectorTraitKeys<TOptions>[]
  ): SectorFactoryInterfaceWithoutTraits;
}

function autoGenerateSectorScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineSectorFactoryInternal<
  TOptions extends SectorFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): SectorFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly SectorTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (inputData: Partial<Prisma.SectorCreateInput> = {}) => {
      ...
      const resolveValue = normalizeResolver<
        SectorFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<SectorFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function defineSectorFactory<
  TOptions extends SectorFactoryDefineOptions,
>(options: TOptions): SectorFactoryInterface<TOptions> {
...
type WallSectorFactory = {
  _factoryFor: "Sector";
  build: () => PromiseLike<
    Prisma.SectorCreateNestedOneWithoutWallsInput["create"]
  >;
};
...
type WallAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorWallInput["create"]
  >;
};
...
function isWallSectorFactory(
  x:
    | WallSectorFactory
    | Prisma.SectorCreateNestedOneWithoutWallsInput
    | undefined,
): x is WallSectorFactory {
  return (x as any)?._factoryFor === "Sector";
}

function isWallAuthorFactory(
  x:
    | WallAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorWallInput
    | undefined,
): x is WallAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

type WallTraitKeys<TOptions extends WallFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface WallFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Wall";
  build(
    inputData?: Partial<Prisma.WallCreateInput>,
  ): PromiseLike<Prisma.WallCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.WallCreateInput>,
  ): PromiseLike<Prisma.WallCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.WallCreateInput>[],
  ): PromiseLike<Prisma.WallCreateInput[]>;
  ...
  createForConnect(
    inputData?: Partial<Prisma.WallCreateInput>,
  ): PromiseLike<Pick<Wall, "id">>;
}

export interface WallFactoryInterface<
  TOptions extends WallFactoryDefineOptions = WallFactoryDefineOptions,
> extends WallFactoryInterfaceWithoutTraits {
  use(
    name: WallTraitKeys<TOptions>,
    ...names: readonly WallTraitKeys<TOptions>[]
  ): WallFactoryInterfaceWithoutTraits;
}

function autoGenerateWallScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineWallFactoryInternal<TOptions extends WallFactoryDefineOptions>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): WallFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly WallTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (inputData: Partial<Prisma.WallCreateInput> = {}) => {
      ...
      const resolveValue = normalizeResolver<
        WallFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<WallFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.WallCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineWallFactory<TOptions extends WallFactoryDefineOptions>(
  options: TOptions,
): WallFactoryInterface<TOptions> {
...
type TopoWallFactory = {
  _factoryFor: "Wall";
  build: () => PromiseLike<
    Prisma.WallCreateNestedOneWithoutToposInput["create"]
  >;
};
...
type TopoimageFactory = {
  _factoryFor: "Image";
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutTopoInput["create"]
  >;
};
...
type TopoAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorTopoInput["create"]
  >;
};
...
function isTopoWallFactory(
  x: TopoWallFactory | Prisma.WallCreateNestedOneWithoutToposInput | undefined,
): x is TopoWallFactory {
  return (x as any)?._factoryFor === "Wall";
}

function isTopoimageFactory(
  x: TopoimageFactory | Prisma.ImageCreateNestedOneWithoutTopoInput | undefined,
): x is TopoimageFactory {
  return (x as any)?._factoryFor === "Image";
}

function isTopoAuthorFactory(
  x:
    | TopoAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorTopoInput
    | undefined,
): x is TopoAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

type TopoTraitKeys<TOptions extends TopoFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface TopoFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Topo";
  build(
    inputData?: Partial<Prisma.TopoCreateInput>,
  ): PromiseLike<Prisma.TopoCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.TopoCreateInput>,
  ): PromiseLike<Prisma.TopoCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.TopoCreateInput>[],
  ): PromiseLike<Prisma.TopoCreateInput[]>;
  ...
  createForConnect(
    inputData?: Partial<Prisma.TopoCreateInput>,
  ): PromiseLike<Pick<Topo, "id">>;
}

export interface TopoFactoryInterface<
  TOptions extends TopoFactoryDefineOptions = TopoFactoryDefineOptions,
> extends TopoFactoryInterfaceWithoutTraits {
  use(
    name: TopoTraitKeys<TOptions>,
    ...names: readonly TopoTraitKeys<TOptions>[]
  ): TopoFactoryInterfaceWithoutTraits;
}

function autoGenerateTopoScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineTopoFactoryInternal<TOptions extends TopoFactoryDefineOptions>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): TopoFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly TopoTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (inputData: Partial<Prisma.TopoCreateInput> = {}) => {
      ...
      const resolveValue = normalizeResolver<
        TopoFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<TopoFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.TopoCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineTopoFactory<TOptions extends TopoFactoryDefineOptions>(
  options: TOptions,
): TopoFactoryInterface<TOptions> {
...
type RouteWallFactory = {
  _factoryFor: "Wall";
  build: () => PromiseLike<
    Prisma.WallCreateNestedOneWithoutRoutesInput["create"]
  >;
};
...
type RoutedescriptionFactory = {
  _factoryFor: "TextContent";
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutRouteInput["create"]
  >;
};
...
type RouteRouteLengthFactory = {
  ...
  build: () => PromiseLike<
    Prisma.RouteLengthCreateNestedOneWithoutRouteInput["create"]
  >;
};
...
type RouteRouteGradeFactory = {
  ...
  build: () => PromiseLike<
    Prisma.RouteGradeCreateNestedOneWithoutRouteInput["create"]
  >;
};
...
type RouteAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorRouteInput["create"]
  >;
};
...
type RouteExtendedRouteFactory = {
  _factoryFor: "Route";
  build: () => PromiseLike<
    Prisma.RouteCreateNestedOneWithoutExtensionInput["create"]
  >;
};
...
type RouteVariantRouteFactory = {
  _factoryFor: "Route";
  build: () => PromiseLike<
    Prisma.RouteCreateNestedOneWithoutVariantInput["create"]
  >;
};
...
type RoutePitchFactory = {
  _factoryFor: "Pitch";
  build: () => PromiseLike<
    Prisma.PitchCreateNestedOneWithoutRouteInput["create"]
  >;
};
...
type RouteFactoryDefineInput = {
  ...
  description?:
    | RoutedescriptionFactory
    | Prisma.TextContentCreateNestedOneWithoutRouteInput;
  RouteLength?:
    | RouteRouteLengthFactory
    | Prisma.RouteLengthCreateNestedOneWithoutRouteInput;
  RoutePath?: Prisma.RoutePathCreateNestedManyWithoutRouteInput;
  RouteGrade?:
    | RouteRouteGradeFactory
    | Prisma.RouteGradeCreateNestedOneWithoutRouteInput;
  Author:
    | RouteAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorRouteInput;
  coAuthors?: Prisma.UserCreateNestedManyWithoutCoAuthorRouteInput;
  ExtendedRoute?:
    | RouteExtendedRouteFactory
    | Prisma.RouteCreateNestedOneWithoutExtensionInput;
  Extension?: Prisma.RouteCreateNestedManyWithoutExtendedRouteInput;
  VariantRoute?:
    | RouteVariantRouteFactory
    | Prisma.RouteCreateNestedOneWithoutVariantInput;
...
function isRouteWallFactory(
  x:
    | RouteWallFactory
    | Prisma.WallCreateNestedOneWithoutRoutesInput
    | undefined,
): x is RouteWallFactory {
  return (x as any)?._factoryFor === "Wall";
}

function isRoutedescriptionFactory(
  x:
    | RoutedescriptionFactory
    | Prisma.TextContentCreateNestedOneWithoutRouteInput
    | undefined,
): x is RoutedescriptionFactory {
  return (x as any)?._factoryFor === "TextContent";
}

function isRouteRouteLengthFactory(
  x:
    | RouteRouteLengthFactory
    | Prisma.RouteLengthCreateNestedOneWithoutRouteInput
    | undefined,
): x is RouteRouteLengthFactory {
  return (x as any)?._factoryFor === "RouteLength";
}

function isRouteRouteGradeFactory(
  x:
    | RouteRouteGradeFactory
    | Prisma.RouteGradeCreateNestedOneWithoutRouteInput
    | undefined,
): x is RouteRouteGradeFactory {
  return (x as any)?._factoryFor === "RouteGrade";
}

function isRouteAuthorFactory(
  x:
    | RouteAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorRouteInput
    | undefined,
): x is RouteAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

function isRouteExtendedRouteFactory(
  x:
    | RouteExtendedRouteFactory
    | Prisma.RouteCreateNestedOneWithoutExtensionInput
    | undefined,
): x is RouteExtendedRouteFactory {
  return (x as any)?._factoryFor === "Route";
}

function isRouteVariantRouteFactory(
  x:
    | RouteVariantRouteFactory
    | Prisma.RouteCreateNestedOneWithoutVariantInput
    | undefined,
): x is RouteVariantRouteFactory {
  return (x as any)?._factoryFor === "Route";
}

function isRoutePitchFactory(
  x:
    | RoutePitchFactory
    | Prisma.PitchCreateNestedOneWithoutRouteInput
    | undefined,
): x is RoutePitchFactory {
  return (x as any)?._factoryFor === "Pitch";
}

type RouteTraitKeys<TOptions extends RouteFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface RouteFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Route";
  build(
    inputData?: Partial<Prisma.RouteCreateInput>,
  ): PromiseLike<Prisma.RouteCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.RouteCreateInput>,
  ): PromiseLike<Prisma.RouteCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.RouteCreateInput>[],
  ): PromiseLike<Prisma.RouteCreateInput[]>;
  ...
  createForConnect(
    inputData?: Partial<Prisma.RouteCreateInput>,
  ): PromiseLike<Pick<Route, "id">>;
}

export interface RouteFactoryInterface<
  TOptions extends RouteFactoryDefineOptions = RouteFactoryDefineOptions,
> extends RouteFactoryInterfaceWithoutTraits {
  use(
    name: RouteTraitKeys<TOptions>,
    ...names: readonly RouteTraitKeys<TOptions>[]
  ): RouteFactoryInterfaceWithoutTraits;
}

function autoGenerateRouteScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineRouteFactoryInternal<
  TOptions extends RouteFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): RouteFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly RouteTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (inputData: Partial<Prisma.RouteCreateInput> = {}) => {
      ...
      const resolveValue = normalizeResolver<
        RouteFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<RouteFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function defineRouteFactory<TOptions extends RouteFactoryDefineOptions>(
  options: TOptions,
): RouteFactoryInterface<TOptions> {
...
type RouteLengthRouteFactory = {
  _factoryFor: "Route";
  build: () => PromiseLike<
    Prisma.RouteCreateNestedOneWithoutRouteLengthInput["create"]
  >;
};
...
type RouteLengthFactoryDefineInput = {
  ...
  unit?: Unit;
  Route:
    | RouteLengthRouteFactory
    | Prisma.RouteCreateNestedOneWithoutRouteLengthInput;
};
...
function isRouteLengthRouteFactory(
  x:
    | RouteLengthRouteFactory
    | Prisma.RouteCreateNestedOneWithoutRouteLengthInput
    | undefined,
): x is RouteLengthRouteFactory {
  return (x as any)?._factoryFor === "Route";
}

type RouteLengthTraitKeys<TOptions extends RouteLengthFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface RouteLengthFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "RouteLength";
  build(
    inputData?: Partial<Prisma.RouteLengthCreateInput>,
  ): PromiseLike<Prisma.RouteLengthCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.RouteLengthCreateInput>,
  ): PromiseLike<Prisma.RouteLengthCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.RouteLengthCreateInput>[],
  ): PromiseLike<Prisma.RouteLengthCreateInput[]>;
  pickForConnect(inputData: RouteLength): Pick<RouteLength, "id">;
  create(
    inputData?: Partial<Prisma.RouteLengthCreateInput>,
  ): PromiseLike<RouteLength>;
  createList(
    inputData: number | readonly Partial<Prisma.RouteLengthCreateInput>[],
  ): PromiseLike<RouteLength[]>;
  createForConnect(
    inputData?: Partial<Prisma.RouteLengthCreateInput>,
  ): PromiseLike<Pick<RouteLength, "id">>;
}

export interface RouteLengthFactoryInterface<
  TOptions extends RouteLengthFactoryDefineOptions = RouteLengthFactoryDefineOptions,
> extends RouteLengthFactoryInterfaceWithoutTraits {
  use(
    name: RouteLengthTraitKeys<TOptions>,
    ...names: readonly RouteLengthTraitKeys<TOptions>[]
  ): RouteLengthFactoryInterfaceWithoutTraits;
}

function autoGenerateRouteLengthScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): RouteLengthScalarOrEnumFields {
  return {
    length: getScalarFieldValueGenerator().Decimal({
      modelName: "RouteLength",
      fieldName: "length",
      isId: false,
      isUnique: false,
      seq,
...
function defineRouteLengthFactoryInternal<
  TOptions extends RouteLengthFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): RouteLengthFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly RouteLengthTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        RouteLengthFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<RouteLengthFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.RouteLengthCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineRouteLengthFactory<
  TOptions extends RouteLengthFactoryDefineOptions,
>(options: TOptions): RouteLengthFactoryInterface<TOptions> {
...
type MultiPitchWallFactory = {
  _factoryFor: "Wall";
  build: () => PromiseLike<
    Prisma.WallCreateNestedOneWithoutMultiPitchInput["create"]
  >;
};
...
type MultiPitchAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorMultiPitchInput["create"]
  >;
};
...
type MultiPitchFactoryDefineInput = {
  ...
  Wall:
    | MultiPitchWallFactory
    | Prisma.WallCreateNestedOneWithoutMultiPitchInput;
  Author:
    | MultiPitchAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorMultiPitchInput;
...
function isMultiPitchWallFactory(
  x:
    | MultiPitchWallFactory
    | Prisma.WallCreateNestedOneWithoutMultiPitchInput
    | undefined,
): x is MultiPitchWallFactory {
  return (x as any)?._factoryFor === "Wall";
}

function isMultiPitchAuthorFactory(
  x:
    | MultiPitchAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorMultiPitchInput
    | undefined,
): x is MultiPitchAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

type MultiPitchTraitKeys<TOptions extends MultiPitchFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface MultiPitchFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "MultiPitch";
  build(
    inputData?: Partial<Prisma.MultiPitchCreateInput>,
  ): PromiseLike<Prisma.MultiPitchCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.MultiPitchCreateInput>,
  ): PromiseLike<Prisma.MultiPitchCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.MultiPitchCreateInput>[],
  ): PromiseLike<Prisma.MultiPitchCreateInput[]>;
  pickForConnect(inputData: MultiPitch): Pick<MultiPitch, "id">;
  create(
    inputData?: Partial<Prisma.MultiPitchCreateInput>,
  ): PromiseLike<MultiPitch>;
  createList(
    inputData: number | readonly Partial<Prisma.MultiPitchCreateInput>[],
  ): PromiseLike<MultiPitch[]>;
  createForConnect(
    inputData?: Partial<Prisma.MultiPitchCreateInput>,
  ): PromiseLike<Pick<MultiPitch, "id">>;
}

export interface MultiPitchFactoryInterface<
  TOptions extends MultiPitchFactoryDefineOptions = MultiPitchFactoryDefineOptions,
> extends MultiPitchFactoryInterfaceWithoutTraits {
  use(
    name: MultiPitchTraitKeys<TOptions>,
    ...names: readonly MultiPitchTraitKeys<TOptions>[]
  ): MultiPitchFactoryInterfaceWithoutTraits;
}

function autoGenerateMultiPitchScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineMultiPitchFactoryInternal<
  TOptions extends MultiPitchFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): MultiPitchFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly MultiPitchTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        MultiPitchFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<MultiPitchFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.MultiPitchCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineMultiPitchFactory<
  TOptions extends MultiPitchFactoryDefineOptions,
>(options: TOptions): MultiPitchFactoryInterface<TOptions> {
...
type PitchRouteFactory = {
  _factoryFor: "Route";
  build: () => PromiseLike<
    Prisma.RouteCreateNestedOneWithoutPitchInput["create"]
  >;
};
...
type PitchMultiPitchFactory = {
  ...
  build: () => PromiseLike<
    Prisma.MultiPitchCreateNestedOneWithoutPitchesInput["create"]
  >;
};
...
type PitchVariantPitchFactory = {
  _factoryFor: "Pitch";
  build: () => PromiseLike<
    Prisma.PitchCreateNestedOneWithoutVariantInput["create"]
  >;
};
...
type PitchFactoryDefineInput = {
  ...
  MultiPitch:
    | PitchMultiPitchFactory
    | Prisma.MultiPitchCreateNestedOneWithoutPitchesInput;
  VariantPitch?:
    | PitchVariantPitchFactory
    | Prisma.PitchCreateNestedOneWithoutVariantInput;
...
function isPitchRouteFactory(
  x:
    | PitchRouteFactory
    | Prisma.RouteCreateNestedOneWithoutPitchInput
    | undefined,
): x is PitchRouteFactory {
  return (x as any)?._factoryFor === "Route";
}

function isPitchMultiPitchFactory(
  x:
    | PitchMultiPitchFactory
    | Prisma.MultiPitchCreateNestedOneWithoutPitchesInput
    | undefined,
): x is PitchMultiPitchFactory {
  return (x as any)?._factoryFor === "MultiPitch";
}

function isPitchVariantPitchFactory(
  x:
    | PitchVariantPitchFactory
    | Prisma.PitchCreateNestedOneWithoutVariantInput
    | undefined,
): x is PitchVariantPitchFactory {
  return (x as any)?._factoryFor === "Pitch";
}

type PitchTraitKeys<TOptions extends PitchFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface PitchFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Pitch";
  build(
    inputData?: Partial<Prisma.PitchCreateInput>,
  ): PromiseLike<Prisma.PitchCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.PitchCreateInput>,
  ): PromiseLike<Prisma.PitchCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.PitchCreateInput>[],
  ): PromiseLike<Prisma.PitchCreateInput[]>;
  ...
  createForConnect(
    inputData?: Partial<Prisma.PitchCreateInput>,
  ): PromiseLike<Pick<Pitch, "id">>;
}

export interface PitchFactoryInterface<
  TOptions extends PitchFactoryDefineOptions = PitchFactoryDefineOptions,
> extends PitchFactoryInterfaceWithoutTraits {
  use(
    name: PitchTraitKeys<TOptions>,
    ...names: readonly PitchTraitKeys<TOptions>[]
  ): PitchFactoryInterfaceWithoutTraits;
}

function autoGeneratePitchScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): PitchScalarOrEnumFields {
  return {
    number: getScalarFieldValueGenerator().Decimal({
      modelName: "Pitch",
      fieldName: "number",
      isId: false,
      isUnique: false,
...
function definePitchFactoryInternal<
  TOptions extends PitchFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): PitchFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly PitchTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (inputData: Partial<Prisma.PitchCreateInput> = {}) => {
      ...
      const resolveValue = normalizeResolver<
        PitchFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<PitchFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function definePitchFactory<TOptions extends PitchFactoryDefineOptions>(
  options: TOptions,
): PitchFactoryInterface<TOptions> {
...
type RouteGraderouteFactory = {
  _factoryFor: "Route";
  build: () => PromiseLike<
    Prisma.RouteCreateNestedOneWithoutRouteGradeInput["create"]
  >;
};
...
type RouteGradeFactoryDefineInput = {
  ...
  route:
    | RouteGraderouteFactory
    | Prisma.RouteCreateNestedOneWithoutRouteGradeInput;
};
...
function isRouteGraderouteFactory(
  x:
    | RouteGraderouteFactory
    | Prisma.RouteCreateNestedOneWithoutRouteGradeInput
    | undefined,
): x is RouteGraderouteFactory {
  return (x as any)?._factoryFor === "Route";
}

type RouteGradeTraitKeys<TOptions extends RouteGradeFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface RouteGradeFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "RouteGrade";
  build(
    inputData?: Partial<Prisma.RouteGradeCreateInput>,
  ): PromiseLike<Prisma.RouteGradeCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.RouteGradeCreateInput>,
  ): PromiseLike<Prisma.RouteGradeCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.RouteGradeCreateInput>[],
  ): PromiseLike<Prisma.RouteGradeCreateInput[]>;
  pickForConnect(inputData: RouteGrade): Pick<RouteGrade, "id">;
  create(
    inputData?: Partial<Prisma.RouteGradeCreateInput>,
  ): PromiseLike<RouteGrade>;
  createList(
    inputData: number | readonly Partial<Prisma.RouteGradeCreateInput>[],
  ): PromiseLike<RouteGrade[]>;
  createForConnect(
    inputData?: Partial<Prisma.RouteGradeCreateInput>,
  ): PromiseLike<Pick<RouteGrade, "id">>;
}

export interface RouteGradeFactoryInterface<
  TOptions extends RouteGradeFactoryDefineOptions = RouteGradeFactoryDefineOptions,
> extends RouteGradeFactoryInterfaceWithoutTraits {
  use(
    name: RouteGradeTraitKeys<TOptions>,
    ...names: readonly RouteGradeTraitKeys<TOptions>[]
  ): RouteGradeFactoryInterfaceWithoutTraits;
}

function autoGenerateRouteGradeScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineRouteGradeFactoryInternal<
  TOptions extends RouteGradeFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): RouteGradeFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly RouteGradeTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        RouteGradeFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<RouteGradeFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.RouteGradeCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineRouteGradeFactory<
  TOptions extends RouteGradeFactoryDefineOptions,
>(options: TOptions): RouteGradeFactoryInterface<TOptions> {
...
type RoutePathTopoFactory = {
  _factoryFor: "Topo";
  build: () => PromiseLike<
    Prisma.TopoCreateNestedOneWithoutRoutePathInput["create"]
  >;
};
...
type RoutePathRouteFactory = {
  _factoryFor: "Route";
  build: () => PromiseLike<
    Prisma.RouteCreateNestedOneWithoutRoutePathInput["create"]
  >;
};
...
type RoutePathAuthorFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAuthorRoutePathInput["create"]
  >;
};
...
type RoutePathFactoryDefineInput = {
  ...
  Route:
    | RoutePathRouteFactory
    | Prisma.RouteCreateNestedOneWithoutRoutePathInput;
  Author:
    | RoutePathAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorRoutePathInput;
...
function isRoutePathTopoFactory(
  x:
    | RoutePathTopoFactory
    | Prisma.TopoCreateNestedOneWithoutRoutePathInput
    | undefined,
): x is RoutePathTopoFactory {
  return (x as any)?._factoryFor === "Topo";
}

function isRoutePathRouteFactory(
  x:
    | RoutePathRouteFactory
    | Prisma.RouteCreateNestedOneWithoutRoutePathInput
    | undefined,
): x is RoutePathRouteFactory {
  return (x as any)?._factoryFor === "Route";
}

function isRoutePathAuthorFactory(
  x:
    | RoutePathAuthorFactory
    | Prisma.UserCreateNestedOneWithoutAuthorRoutePathInput
    | undefined,
): x is RoutePathAuthorFactory {
  return (x as any)?._factoryFor === "User";
}

type RoutePathTraitKeys<TOptions extends RoutePathFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface RoutePathFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "RoutePath";
  build(
    inputData?: Partial<Prisma.RoutePathCreateInput>,
  ): PromiseLike<Prisma.RoutePathCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.RoutePathCreateInput>,
  ): PromiseLike<Prisma.RoutePathCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.RoutePathCreateInput>[],
  ): PromiseLike<Prisma.RoutePathCreateInput[]>;
  ...
  createForConnect(
    inputData?: Partial<Prisma.RoutePathCreateInput>,
  ): PromiseLike<Pick<RoutePath, "id">>;
}

export interface RoutePathFactoryInterface<
  TOptions extends RoutePathFactoryDefineOptions = RoutePathFactoryDefineOptions,
> extends RoutePathFactoryInterfaceWithoutTraits {
  use(
    name: RoutePathTraitKeys<TOptions>,
    ...names: readonly RoutePathTraitKeys<TOptions>[]
  ): RoutePathFactoryInterfaceWithoutTraits;
}

function autoGenerateRoutePathScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): RoutePathScalarOrEnumFields {
  return {
    path: getScalarFieldValueGenerator().String({
      modelName: "RoutePath",
      fieldName: "path",
      isId: false,
      isUnique: false,
...
function defineRoutePathFactoryInternal<
  TOptions extends RoutePathFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): RoutePathFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly RoutePathTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        RoutePathFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<RoutePathFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.RoutePathCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineRoutePathFactory<
  TOptions extends RoutePathFactoryDefineOptions,
>(options: TOptions): RoutePathFactoryInterface<TOptions> {
...
type RouteEvaluationRouteFactory = {
  _factoryFor: "Route";
  build: () => PromiseLike<
    Prisma.RouteCreateNestedOneWithoutRouteEvaluationInput["create"]
  >;
};
...
type RouteEvaluationUserFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutRouteEvaluationInput["create"]
  >;
};
...
type RouteEvaluationFactoryDefineInput = {
  ...
  isDeleted?: SoftDelete;
  Route:
    | RouteEvaluationRouteFactory
    | Prisma.RouteCreateNestedOneWithoutRouteEvaluationInput;
  User:
    | RouteEvaluationUserFactory
    | Prisma.UserCreateNestedOneWithoutRouteEvaluationInput;
};
...
type RouteEvaluationFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<RouteEvaluationFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
function isRouteEvaluationRouteFactory(
  x:
    | RouteEvaluationRouteFactory
    | Prisma.RouteCreateNestedOneWithoutRouteEvaluationInput
    | undefined,
): x is RouteEvaluationRouteFactory {
  return (x as any)?._factoryFor === "Route";
}

function isRouteEvaluationUserFactory(
  x:
    | RouteEvaluationUserFactory
    | Prisma.UserCreateNestedOneWithoutRouteEvaluationInput
    | undefined,
): x is RouteEvaluationUserFactory {
  return (x as any)?._factoryFor === "User";
}

type RouteEvaluationTraitKeys<
  TOptions extends RouteEvaluationFactoryDefineOptions,
> = keyof TOptions["traits"];

export interface RouteEvaluationFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "RouteEvaluation";
  build(
    inputData?: Partial<Prisma.RouteEvaluationCreateInput>,
  ): PromiseLike<Prisma.RouteEvaluationCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.RouteEvaluationCreateInput>,
  ): PromiseLike<Prisma.RouteEvaluationCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.RouteEvaluationCreateInput>[],
  ): PromiseLike<Prisma.RouteEvaluationCreateInput[]>;
  pickForConnect(inputData: RouteEvaluation): Pick<RouteEvaluation, "id">;
  create(
    inputData?: Partial<Prisma.RouteEvaluationCreateInput>,
  ): PromiseLike<RouteEvaluation>;
  createList(
    inputData: number | readonly Partial<Prisma.RouteEvaluationCreateInput>[],
  ): PromiseLike<RouteEvaluation[]>;
  createForConnect(
    inputData?: Partial<Prisma.RouteEvaluationCreateInput>,
  ): PromiseLike<Pick<RouteEvaluation, "id">>;
}

export interface RouteEvaluationFactoryInterface<
  TOptions extends RouteEvaluationFactoryDefineOptions = RouteEvaluationFactoryDefineOptions,
> extends RouteEvaluationFactoryInterfaceWithoutTraits {
  use(
    name: RouteEvaluationTraitKeys<TOptions>,
    ...names: readonly RouteEvaluationTraitKeys<TOptions>[]
  ): RouteEvaluationFactoryInterfaceWithoutTraits;
}

function autoGenerateRouteEvaluationScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): RouteEvaluationScalarOrEnumFields {
  return {
    evaluation: getScalarFieldValueGenerator().Decimal({
      modelName: "RouteEvaluation",
...
function defineRouteEvaluationFactoryInternal<
  TOptions extends RouteEvaluationFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): RouteEvaluationFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly RouteEvaluationTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const seq = getSeq();
      const requiredScalarData = autoGenerateRouteEvaluationScalarsOrEnums({
        seq,
      });
      const resolveValue = normalizeResolver<
        RouteEvaluationFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
      ...
      const data: Prisma.RouteEvaluationCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineRouteEvaluationFactory<
  TOptions extends RouteEvaluationFactoryDefineOptions,
>(options: TOptions): RouteEvaluationFactoryInterface<TOptions> {
...
type RouteGradeEvaluationRouteFactory = {
  _factoryFor: "Route";
  build: () => PromiseLike<
    Prisma.RouteCreateNestedOneWithoutRouteGradeEvaluationInput["create"]
  >;
};
...
type RouteGradeEvaluationUserFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutRouteGradeEvaluationInput["create"]
  >;
};
...
type RouteGradeEvaluationFactoryDefineInput = {
  ...
  isDeleted?: SoftDelete;
  Route:
    | RouteGradeEvaluationRouteFactory
    | Prisma.RouteCreateNestedOneWithoutRouteGradeEvaluationInput;
  User:
    | RouteGradeEvaluationUserFactory
    | Prisma.UserCreateNestedOneWithoutRouteGradeEvaluationInput;
};

type RouteGradeEvaluationFactoryDefineOptions = {
  defaultData: Resolver<
    RouteGradeEvaluationFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<RouteGradeEvaluationFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
function isRouteGradeEvaluationRouteFactory(
  x:
    | RouteGradeEvaluationRouteFactory
    | Prisma.RouteCreateNestedOneWithoutRouteGradeEvaluationInput
    | undefined,
): x is RouteGradeEvaluationRouteFactory {
  return (x as any)?._factoryFor === "Route";
}

function isRouteGradeEvaluationUserFactory(
  x:
    | RouteGradeEvaluationUserFactory
    | Prisma.UserCreateNestedOneWithoutRouteGradeEvaluationInput
    | undefined,
): x is RouteGradeEvaluationUserFactory {
  return (x as any)?._factoryFor === "User";
}

type RouteGradeEvaluationTraitKeys<
  TOptions extends RouteGradeEvaluationFactoryDefineOptions,
> = keyof TOptions["traits"];

export interface RouteGradeEvaluationFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "RouteGradeEvaluation";
  build(
    inputData?: Partial<Prisma.RouteGradeEvaluationCreateInput>,
  ): PromiseLike<Prisma.RouteGradeEvaluationCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.RouteGradeEvaluationCreateInput>,
  ): PromiseLike<Prisma.RouteGradeEvaluationCreateInput>;
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.RouteGradeEvaluationCreateInput>[],
  ): PromiseLike<Prisma.RouteGradeEvaluationCreateInput[]>;
  pickForConnect(
    inputData: RouteGradeEvaluation,
  ): Pick<RouteGradeEvaluation, "id">;
  create(
    inputData?: Partial<Prisma.RouteGradeEvaluationCreateInput>,
  ): PromiseLike<RouteGradeEvaluation>;
  createList(
    inputData:
      | number
      | readonly Partial<Prisma.RouteGradeEvaluationCreateInput>[],
  ...
  createForConnect(
    inputData?: Partial<Prisma.RouteGradeEvaluationCreateInput>,
  ): PromiseLike<Pick<RouteGradeEvaluation, "id">>;
}

export interface RouteGradeEvaluationFactoryInterface<
  TOptions extends RouteGradeEvaluationFactoryDefineOptions = RouteGradeEvaluationFactoryDefineOptions,
> extends RouteGradeEvaluationFactoryInterfaceWithoutTraits {
  use(
    name: RouteGradeEvaluationTraitKeys<TOptions>,
    ...names: readonly RouteGradeEvaluationTraitKeys<TOptions>[]
  ): RouteGradeEvaluationFactoryInterfaceWithoutTraits;
}

function autoGenerateRouteGradeEvaluationScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): RouteGradeEvaluationScalarOrEnumFields {
  return {
    evaluation: getScalarFieldValueGenerator().Int({
      modelName: "RouteGradeEvaluation",
      fieldName: "evaluation",
      isId: false,
      isUnique: false,
      seq,
    ...
    originalGrade: getScalarFieldValueGenerator().String({
      modelName: "RouteGradeEvaluation",
      fieldName: "originalGrade",
      isId: false,
      isUnique: false,
      seq,
    }),
...
function defineRouteGradeEvaluationFactoryInternal<
  TOptions extends RouteGradeEvaluationFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): RouteGradeEvaluationFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly RouteGradeEvaluationTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    const screen = createScreener(
    ...
    const build = async (
      ...
      const seq = getSeq();
      const requiredScalarData = autoGenerateRouteGradeEvaluationScalarsOrEnums(
        { seq },
      );
      const resolveValue = normalizeResolver<
        RouteGradeEvaluationFactoryDefineInput,
      ...
      const data: Prisma.RouteGradeEvaluationCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
    ...
    const create = async (
      ...
      const data = await build(inputData).then(screen);
      return await getClient<PrismaClient>().routeGradeEvaluation.create({
        data,
      });
    };
    const createList = (
 ...
 */
export function defineRouteGradeEvaluationFactory<
  TOptions extends RouteGradeEvaluationFactoryDefineOptions,
>(options: TOptions): RouteGradeEvaluationFactoryInterface<TOptions> {
...
type ImageZoneFactory = {
  _factoryFor: "Zone";
  build: () => PromiseLike<
    Prisma.ZoneCreateNestedOneWithoutPhotosInput["create"]
  >;
};
...
function isImageZoneFactory(
  x:
    | ImageZoneFactory
    | Prisma.ZoneCreateNestedOneWithoutPhotosInput
    | undefined,
): x is ImageZoneFactory {
  return (x as any)?._factoryFor === "Zone";
}
...
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): ImageFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly ImageTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
 ...
 */
export function defineImageFactory<TOptions extends ImageFactoryDefineOptions>(
  options?: TOptions,
...
type TextContentoriginalLangFactory = {
  ...
  build: () => PromiseLike<
    Prisma.LanguageCreateNestedOneWithoutTextContentInput["create"]
  >;
};
...
type TextContentFactoryDefineInput = {
  ...
  isDeleted?: SoftDelete;
  originalLang:
    | TextContentoriginalLangFactory
    | Prisma.LanguageCreateNestedOneWithoutTextContentInput;
...
function isTextContentoriginalLangFactory(
  x:
    | TextContentoriginalLangFactory
    | Prisma.LanguageCreateNestedOneWithoutTextContentInput
    | undefined,
): x is TextContentoriginalLangFactory {
  return (x as any)?._factoryFor === "Language";
}

type TextContentTraitKeys<TOptions extends TextContentFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface TextContentFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "TextContent";
  build(
    inputData?: Partial<Prisma.TextContentCreateInput>,
  ): PromiseLike<Prisma.TextContentCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.TextContentCreateInput>,
  ): PromiseLike<Prisma.TextContentCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.TextContentCreateInput>[],
  ): PromiseLike<Prisma.TextContentCreateInput[]>;
  pickForConnect(inputData: TextContent): Pick<TextContent, "id">;
  create(
    inputData?: Partial<Prisma.TextContentCreateInput>,
  ): PromiseLike<TextContent>;
  createList(
    inputData: number | readonly Partial<Prisma.TextContentCreateInput>[],
  ): PromiseLike<TextContent[]>;
  createForConnect(
    inputData?: Partial<Prisma.TextContentCreateInput>,
  ): PromiseLike<Pick<TextContent, "id">>;
}

export interface TextContentFactoryInterface<
  TOptions extends TextContentFactoryDefineOptions = TextContentFactoryDefineOptions,
> extends TextContentFactoryInterfaceWithoutTraits {
  use(
    name: TextContentTraitKeys<TOptions>,
    ...names: readonly TextContentTraitKeys<TOptions>[]
  ): TextContentFactoryInterfaceWithoutTraits;
}

function autoGenerateTextContentScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): TextContentScalarOrEnumFields {
  return {
    originalText: getScalarFieldValueGenerator().String({
...
function defineTextContentFactoryInternal<
  TOptions extends TextContentFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): TextContentFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly TextContentTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        TextContentFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<TextContentFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
      ...
      const data: Prisma.TextContentCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
 ...
 */
export function defineTextContentFactory<
  TOptions extends TextContentFactoryDefineOptions,
>(options: TOptions): TextContentFactoryInterface<TOptions> {
...
type TranslationtextContentFactory = {
  _factoryFor: "TextContent";
  build: () => PromiseLike<
    Prisma.TextContentCreateNestedOneWithoutTranslationInput["create"]
  >;
};
...
type TranslationlanguageFactory = {
  _factoryFor: "Language";
  build: () => PromiseLike<
    Prisma.LanguageCreateNestedOneWithoutTranslationInput["create"]
  >;
};
...
type TranslationFactoryDefineInput = {
  ...
  isDeleted?: SoftDelete;
  textContent:
    | TranslationtextContentFactory
    | Prisma.TextContentCreateNestedOneWithoutTranslationInput;
  language:
    | TranslationlanguageFactory
    | Prisma.LanguageCreateNestedOneWithoutTranslationInput;
};
...
function isTranslationtextContentFactory(
  x:
    | TranslationtextContentFactory
    | Prisma.TextContentCreateNestedOneWithoutTranslationInput
    | undefined,
): x is TranslationtextContentFactory {
  return (x as any)?._factoryFor === "TextContent";
}

function isTranslationlanguageFactory(
  x:
    | TranslationlanguageFactory
    | Prisma.LanguageCreateNestedOneWithoutTranslationInput
    | undefined,
): x is TranslationlanguageFactory {
  return (x as any)?._factoryFor === "Language";
}

type TranslationTraitKeys<TOptions extends TranslationFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface TranslationFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Translation";
  build(
    inputData?: Partial<Prisma.TranslationCreateInput>,
  ): PromiseLike<Prisma.TranslationCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.TranslationCreateInput>,
  ): PromiseLike<Prisma.TranslationCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.TranslationCreateInput>[],
  ): PromiseLike<Prisma.TranslationCreateInput[]>;
  pickForConnect(inputData: Translation): Pick<Translation, "id">;
  create(
    inputData?: Partial<Prisma.TranslationCreateInput>,
  ): PromiseLike<Translation>;
  createList(
    inputData: number | readonly Partial<Prisma.TranslationCreateInput>[],
  ): PromiseLike<Translation[]>;
  createForConnect(
    inputData?: Partial<Prisma.TranslationCreateInput>,
  ): PromiseLike<Pick<Translation, "id">>;
}

export interface TranslationFactoryInterface<
  TOptions extends TranslationFactoryDefineOptions = TranslationFactoryDefineOptions,
> extends TranslationFactoryInterfaceWithoutTraits {
  use(
    name: TranslationTraitKeys<TOptions>,
    ...names: readonly TranslationTraitKeys<TOptions>[]
  ): TranslationFactoryInterfaceWithoutTraits;
}

function autoGenerateTranslationScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): TranslationScalarOrEnumFields {
  return {
    translation: getScalarFieldValueGenerator().String({
...
function defineTranslationFactoryInternal<
  TOptions extends TranslationFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): TranslationFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly TranslationTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        TranslationFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<TranslationFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function defineTranslationFactory<
  TOptions extends TranslationFactoryDefineOptions,
>(options: TOptions): TranslationFactoryInterface<TOptions> {
...
type LanguageTraitKeys<TOptions extends LanguageFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface LanguageFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Language";
  build(
    inputData?: Partial<Prisma.LanguageCreateInput>,
  ): PromiseLike<Prisma.LanguageCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.LanguageCreateInput>,
  ): PromiseLike<Prisma.LanguageCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.LanguageCreateInput>[],
  ): PromiseLike<Prisma.LanguageCreateInput[]>;
  pickForConnect(inputData: Language): Pick<Language, "languageId">;
  create(
    inputData?: Partial<Prisma.LanguageCreateInput>,
  ): PromiseLike<Language>;
  createList(
    inputData: number | readonly Partial<Prisma.LanguageCreateInput>[],
  ): PromiseLike<Language[]>;
  createForConnect(
    inputData?: Partial<Prisma.LanguageCreateInput>,
  ): PromiseLike<Pick<Language, "languageId">>;
}

export interface LanguageFactoryInterface<
  TOptions extends LanguageFactoryDefineOptions = LanguageFactoryDefineOptions,
> extends LanguageFactoryInterfaceWithoutTraits {
  use(
    name: LanguageTraitKeys<TOptions>,
    ...names: readonly LanguageTraitKeys<TOptions>[]
  ): LanguageFactoryInterfaceWithoutTraits;
}

function autoGenerateLanguageScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): LanguageScalarOrEnumFields {
  return {
    languageId: getScalarFieldValueGenerator().String({
      modelName: "Language",
    ...
    languageName: getScalarFieldValueGenerator().String({
      modelName: "Language",
...
function defineLanguageFactoryInternal<
  TOptions extends LanguageFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): LanguageFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly LanguageTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        LanguageFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<LanguageFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function defineLanguageFactory<
  TOptions extends LanguageFactoryDefineOptions,
>(options?: TOptions): LanguageFactoryInterface<TOptions> {
...
type LocationTraitKeys<TOptions extends LocationFactoryDefineOptions> =
  keyof TOptions["traits"];

export interface LocationFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "Location";
  build(
    inputData?: Partial<Prisma.LocationCreateInput>,
  ): PromiseLike<Prisma.LocationCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.LocationCreateInput>,
  ): PromiseLike<Prisma.LocationCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.LocationCreateInput>[],
  ): PromiseLike<Prisma.LocationCreateInput[]>;
  pickForConnect(inputData: Location): Pick<Location, "id">;
  create(
    inputData?: Partial<Prisma.LocationCreateInput>,
  ): PromiseLike<Location>;
  createList(
    inputData: number | readonly Partial<Prisma.LocationCreateInput>[],
  ): PromiseLike<Location[]>;
  createForConnect(
    inputData?: Partial<Prisma.LocationCreateInput>,
  ): PromiseLike<Pick<Location, "id">>;
}

export interface LocationFactoryInterface<
  TOptions extends LocationFactoryDefineOptions = LocationFactoryDefineOptions,
> extends LocationFactoryInterfaceWithoutTraits {
  use(
    name: LocationTraitKeys<TOptions>,
    ...names: readonly LocationTraitKeys<TOptions>[]
  ): LocationFactoryInterfaceWithoutTraits;
}

function autoGenerateLocationScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineLocationFactoryInternal<
  TOptions extends LocationFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): LocationFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly LocationTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const resolveValue = normalizeResolver<
        LocationFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
        const resolveTraitValue = normalizeResolver<
          Partial<LocationFactoryDefineInput>,
          BuildDataOptions
        >(traitsDefs[traitKey]?.data ?? {});
        const traitData = await resolveTraitValue({ seq });
        return {
 ...
 */
export function defineLocationFactory<
  TOptions extends LocationFactoryDefineOptions,
>(options?: TOptions): LocationFactoryInterface<TOptions> {
...
type NotificationReceiverObjectFactory = {
  ...
  build: () => PromiseLike<
    Prisma.NotificationObjectCreateNestedOneWithoutNotificationReceiverInput["create"]
  >;
};
...
type NotificationReceiverReceiverFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutNotificationReceivedInput["create"]
  >;
};
...
type NotificationReceiverFactoryDefineInput = {
  ...
  isRead?: boolean;
  Object:
    | NotificationReceiverObjectFactory
    | Prisma.NotificationObjectCreateNestedOneWithoutNotificationReceiverInput;
  Receiver:
    | NotificationReceiverReceiverFactory
    | Prisma.UserCreateNestedOneWithoutNotificationReceivedInput;
};

type NotificationReceiverFactoryDefineOptions = {
  defaultData: Resolver<
    NotificationReceiverFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<NotificationReceiverFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
function isNotificationReceiverObjectFactory(
  x:
    | NotificationReceiverObjectFactory
    | Prisma.NotificationObjectCreateNestedOneWithoutNotificationReceiverInput
    | undefined,
): x is NotificationReceiverObjectFactory {
  return (x as any)?._factoryFor === "NotificationObject";
}

function isNotificationReceiverReceiverFactory(
  x:
    | NotificationReceiverReceiverFactory
    | Prisma.UserCreateNestedOneWithoutNotificationReceivedInput
    | undefined,
): x is NotificationReceiverReceiverFactory {
  return (x as any)?._factoryFor === "User";
}

type NotificationReceiverTraitKeys<
  TOptions extends NotificationReceiverFactoryDefineOptions,
> = keyof TOptions["traits"];

export interface NotificationReceiverFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "NotificationReceiver";
  build(
    inputData?: Partial<Prisma.NotificationReceiverCreateInput>,
  ): PromiseLike<Prisma.NotificationReceiverCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.NotificationReceiverCreateInput>,
  ): PromiseLike<Prisma.NotificationReceiverCreateInput>;
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.NotificationReceiverCreateInput>[],
  ): PromiseLike<Prisma.NotificationReceiverCreateInput[]>;
  pickForConnect(
    inputData: NotificationReceiver,
  ): Pick<NotificationReceiver, "id">;
  create(
    inputData?: Partial<Prisma.NotificationReceiverCreateInput>,
  ): PromiseLike<NotificationReceiver>;
  createList(
    inputData:
      | number
      | readonly Partial<Prisma.NotificationReceiverCreateInput>[],
  ...
  createForConnect(
    inputData?: Partial<Prisma.NotificationReceiverCreateInput>,
  ): PromiseLike<Pick<NotificationReceiver, "id">>;
}

export interface NotificationReceiverFactoryInterface<
  TOptions extends NotificationReceiverFactoryDefineOptions = NotificationReceiverFactoryDefineOptions,
> extends NotificationReceiverFactoryInterfaceWithoutTraits {
  use(
    name: NotificationReceiverTraitKeys<TOptions>,
    ...names: readonly NotificationReceiverTraitKeys<TOptions>[]
  ): NotificationReceiverFactoryInterfaceWithoutTraits;
}

function autoGenerateNotificationReceiverScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineNotificationReceiverFactoryInternal<
  TOptions extends NotificationReceiverFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): NotificationReceiverFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly NotificationReceiverTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    const screen = createScreener(
    ...
    const build = async (
      ...
      const seq = getSeq();
      const requiredScalarData = autoGenerateNotificationReceiverScalarsOrEnums(
        { seq },
      );
      const resolveValue = normalizeResolver<
        NotificationReceiverFactoryDefineInput,
      ...
      const data: Prisma.NotificationReceiverCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
    ...
    const create = async (
      ...
      const data = await build(inputData).then(screen);
      return await getClient<PrismaClient>().notificationReceiver.create({
        data,
      });
    };
    const createList = (
 ...
 */
export function defineNotificationReceiverFactory<
  TOptions extends NotificationReceiverFactoryDefineOptions,
>(options: TOptions): NotificationReceiverFactoryInterface<TOptions> {
...
type NotificationObjectFactoryDefineOptions = {
  defaultData?: Resolver<
    NotificationObjectFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<NotificationObjectFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type NotificationObjectTraitKeys<
  TOptions extends NotificationObjectFactoryDefineOptions,
> = keyof TOptions["traits"];

export interface NotificationObjectFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "NotificationObject";
  build(
    inputData?: Partial<Prisma.NotificationObjectCreateInput>,
  ): PromiseLike<Prisma.NotificationObjectCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.NotificationObjectCreateInput>,
  ): PromiseLike<Prisma.NotificationObjectCreateInput>;
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.NotificationObjectCreateInput>[],
  ): PromiseLike<Prisma.NotificationObjectCreateInput[]>;
  pickForConnect(inputData: NotificationObject): Pick<NotificationObject, "id">;
  create(
    inputData?: Partial<Prisma.NotificationObjectCreateInput>,
  ): PromiseLike<NotificationObject>;
  createList(
    inputData:
      | number
      | readonly Partial<Prisma.NotificationObjectCreateInput>[],
  ...
  createForConnect(
    inputData?: Partial<Prisma.NotificationObjectCreateInput>,
  ): PromiseLike<Pick<NotificationObject, "id">>;
}

export interface NotificationObjectFactoryInterface<
  TOptions extends NotificationObjectFactoryDefineOptions = NotificationObjectFactoryDefineOptions,
> extends NotificationObjectFactoryInterfaceWithoutTraits {
  use(
    name: NotificationObjectTraitKeys<TOptions>,
    ...names: readonly NotificationObjectTraitKeys<TOptions>[]
  ): NotificationObjectFactoryInterfaceWithoutTraits;
}

function autoGenerateNotificationObjectScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
}): NotificationObjectScalarOrEnumFields {
  return {
    entityId: getScalarFieldValueGenerator().String({
    ...
    messageSent: getScalarFieldValueGenerator().String({
      modelName: "NotificationObject",
...
function defineNotificationObjectFactoryInternal<
  TOptions extends NotificationObjectFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): NotificationObjectFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly NotificationObjectTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const seq = getSeq();
      const requiredScalarData = autoGenerateNotificationObjectScalarsOrEnums({
        seq,
      });
      const resolveValue = normalizeResolver<
        NotificationObjectFactoryDefineInput,
      ...
      const defaultAssociations = {};
      const data: Prisma.NotificationObjectCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
    ...
    const create = async (
      ...
      const data = await build(inputData).then(screen);
      return await getClient<PrismaClient>().notificationObject.create({
        data,
      });
    };
    const createList = (
 ...
 */
export function defineNotificationObjectFactory<
  TOptions extends NotificationObjectFactoryDefineOptions,
>(options?: TOptions): NotificationObjectFactoryInterface<TOptions> {
...
type NotificationSenderObjectFactory = {
  _factoryFor: "NotificationObject";
  build: () => PromiseLike<
    Prisma.NotificationObjectCreateNestedOneWithoutNotificationSenderInput["create"]
  >;
};
...
type NotificationSenderSenderFactory = {
  _factoryFor: "User";
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutNotificationSentInput["create"]
  >;
};
...
type NotificationSenderFactoryDefineInput = {
  id?: string;
  Object:
    | NotificationSenderObjectFactory
    | Prisma.NotificationObjectCreateNestedOneWithoutNotificationSenderInput;
  Sender:
    | NotificationSenderSenderFactory
    | Prisma.UserCreateNestedOneWithoutNotificationSentInput;
};
...
type NotificationSenderFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<NotificationSenderFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
function isNotificationSenderObjectFactory(
  x:
    | NotificationSenderObjectFactory
    | Prisma.NotificationObjectCreateNestedOneWithoutNotificationSenderInput
    | undefined,
): x is NotificationSenderObjectFactory {
  return (x as any)?._factoryFor === "NotificationObject";
}

function isNotificationSenderSenderFactory(
  x:
    | NotificationSenderSenderFactory
    | Prisma.UserCreateNestedOneWithoutNotificationSentInput
    | undefined,
): x is NotificationSenderSenderFactory {
  return (x as any)?._factoryFor === "User";
}

type NotificationSenderTraitKeys<
  TOptions extends NotificationSenderFactoryDefineOptions,
> = keyof TOptions["traits"];

export interface NotificationSenderFactoryInterfaceWithoutTraits {
  readonly _factoryFor: "NotificationSender";
  build(
    inputData?: Partial<Prisma.NotificationSenderCreateInput>,
  ): PromiseLike<Prisma.NotificationSenderCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.NotificationSenderCreateInput>,
  ): PromiseLike<Prisma.NotificationSenderCreateInput>;
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.NotificationSenderCreateInput>[],
  ): PromiseLike<Prisma.NotificationSenderCreateInput[]>;
  pickForConnect(inputData: NotificationSender): Pick<NotificationSender, "id">;
  create(
    inputData?: Partial<Prisma.NotificationSenderCreateInput>,
  ): PromiseLike<NotificationSender>;
  createList(
    inputData:
      | number
      | readonly Partial<Prisma.NotificationSenderCreateInput>[],
  ...
  createForConnect(
    inputData?: Partial<Prisma.NotificationSenderCreateInput>,
  ): PromiseLike<Pick<NotificationSender, "id">>;
}

export interface NotificationSenderFactoryInterface<
  TOptions extends NotificationSenderFactoryDefineOptions = NotificationSenderFactoryDefineOptions,
> extends NotificationSenderFactoryInterfaceWithoutTraits {
  use(
    name: NotificationSenderTraitKeys<TOptions>,
    ...names: readonly NotificationSenderTraitKeys<TOptions>[]
  ): NotificationSenderFactoryInterfaceWithoutTraits;
}

function autoGenerateNotificationSenderScalarsOrEnums({
  seq,
}: {
  readonly seq: number;
...
function defineNotificationSenderFactoryInternal<
  TOptions extends NotificationSenderFactoryDefineOptions,
>({
  defaultData: defaultDataResolver,
  traits: traitsDefs = {},
}: TOptions): NotificationSenderFactoryInterface<TOptions> {
  const getFactoryWithTraits = (
    traitKeys: readonly NotificationSenderTraitKeys<TOptions>[] = [],
  ) => {
    const seqKey = {};
    const getSeq = () => getSequenceCounter(seqKey);
    ...
    const build = async (
      ...
      const seq = getSeq();
      const requiredScalarData = autoGenerateNotificationSenderScalarsOrEnums({
        seq,
      });
      const resolveValue = normalizeResolver<
        NotificationSenderFactoryDefineInput,
        BuildDataOptions
      >(defaultDataResolver ?? {});
      const defaultData = await traitKeys.reduce(async (queue, traitKey) => {
        const acc = await queue;
      ...
      const data: Prisma.NotificationSenderCreateInput = {
        ...requiredScalarData,
        ...defaultData,
        ...defaultAssociations,
        ...inputData,
    ...
    const create = async (
      ...
      const data = await build(inputData).then(screen);
      return await getClient<PrismaClient>().notificationSender.create({
        data,
      });
    };
    const createList = (
 ...
 */
export function defineNotificationSenderFactory<
  TOptions extends NotificationSenderFactoryDefineOptions,
>(options: TOptions): NotificationSenderFactoryInterface<TOptions> {
